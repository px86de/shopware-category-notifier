...
class CategorySubscriptionController extends StorefrontController
{
    ...
    public function subscribe(Request $request, RequestDataBag $data, SalesChannelContext $context): JsonResponse
    {
        ...
        if ($existing) {
            ...
            $this->categorySubscriptionRepository->create([$subscriptionData], $context->getContext());
        }
    ...
    #[Route(path: '/category-notifier/unsubscribe/{email}/{categoryId}', name: 'px86_category_notifier_unsubscribe', methods: ['GET'])]
